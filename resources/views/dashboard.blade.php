            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                <div>
                    ...
                    <p class="text-emerald-600 mt-1 font-medium">
                        Laporan kebun finansialmu hari ini.
                    </p>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                ...
                <div class="relative group overflow-hidden rounded-[2.5rem] h-full shadow-[0_15px_40px_rgba(36,84,55,0.05)]">
                    ...
                    <div class="bg-white p-8 border border-white h-full relative">
                        ...
                        <button @click="jendelaTerbuka = false"
                                x-show="jendelaTerbuka"
                                x-cloak
                                class="absolute top-4 right-4 text-emerald-300 hover:text-emerald-600 transition-colors z-30">
                        ...
                        <div class="flex items-center gap-3 mb-4">
                            <span class="p-2 bg-emerald-100 rounded-lg text-emerald-600 text-xl">
                                💰
                            </span>
                        ...
                        <!-- DATA DARI DATABASE -->
                        <p class="font-display text-4xl text-[#245437]">
                            Rp {{ number_format($totalSaldo, 0, ',', '.') }}
                        </p>

                        <p class="text-xs text-emerald-500 mt-2 font-medium">
                            Saldo seluruh akun aktif
                        </p>
                    </div>
                    ...
                    <div x-show="!jendelaTerbuka"
                        ...
                        <div class="absolute inset-0 opacity-10 bg-[url('https://www.transparenttextures.com/patterns/leaf.png')]">
                        </div>

                        <span class="text-4xl mb-2 animate-garden-breeze">
                            🌿
                        </span>

                        <p class="text-white font-bold text-xs tracking-[0.2em] uppercase">
                            Buka Jendela
                        </p>
                    </div>
                </div>
                ...
                <!-- TOTAL PENGELUARAN -->
                <div class="bg-white p-8 rounded-[2.5rem] shadow-[0_15px_40px_rgba(36,84,55,0.05)]">
                    <div class="flex items-center gap-3 mb-4">
                        <span class="p-2 bg-orange-100 rounded-lg text-orange-600 text-xl">
                            📉
                        </span>
                ...
                <div class="bg-[#245437] p-8 rounded-[2.5rem] shadow-xl text-white relative overflow-hidden flex flex-col justify-center border-4 border-emerald-400/20">
                    ...
                    <div class="flex justify-between items-start relative z-10">
                        ...
                        <p class="text-xs font-bold text-emerald-300 uppercase tracking-widest opacity-80">
                            Sisa Anggaran
                        </p>

                        <button class="bg-white/10 hover:bg-white/20 p-2 rounded-xl transition-all">
                    ...
                    <p class="font-display text-4xl mt-2 relative z-10">
                        Rp 0
                    </p>
                    ...
                    <div class="absolute -right-4 -bottom-4 text-6xl opacity-10 rotate-12">
                        🍃
                    </div>
                </div>
